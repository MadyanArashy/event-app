    ...
    <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
        <div class="mx-auto grid max-w-screen-xl px-4 pb-8 md:grid-cols-12 lg:gap-12 lg:pb-16 xl:gap-0">
          <div class="content-center justify-self-start md:col-span-7 md:text-start">
            ...
            @if(Auth::user() !== null)
            <a href="{{ route('events.index') }}" class="inline-block rounded-lg bg-primary-700 px-3 py-2 text-center font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                Daftar Event
            </a>
            @else
            <button
            id="loginModalButton" data-modal-target="loginModal" data-modal-toggle="loginModal" type="button"
            class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white bg-primary-500 hover:bg-primary-700"
            >
            {{ __('Login') }}
            </button>
            @endif
      ...
      <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="max-w-screen-lg">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Aplikasi CRUD event oleh Madyan Arashy.</h2>
